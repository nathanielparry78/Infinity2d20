...
interface IHazardTestOrCriminalRecordProperties {
}

export class HazardTestOrCriminalRecordEvent extends React.Component<IHazardTestOrCriminalRecordProperties, {}> {
    constructor(props: IHazardTestOrCriminalRecordProperties) {
        super(props);
    }
    ...
    render() {
        ...
        return (
            <div>
                <div className="panel">
                    <div>
                        You must pass an Challenging (D2) hazard test for your current career or you gain a criminal record.
                    </div>
                    {skills}
                </div>
            </div>
    ...
    private onConfirm(skill: Skill, difficulty: number) {
        ...
        if (roll.successes > 0 && !roll.hasRepercusions) {
            ...
            Navigation.navigateToPage(PageIdentity.CriminalRecord);
        }
    }
}